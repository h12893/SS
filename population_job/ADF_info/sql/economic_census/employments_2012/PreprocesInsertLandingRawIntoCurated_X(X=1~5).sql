...
SET column_9 =
    CASE
        ...
        WHEN column_9 = N'@農業，林業，漁業 間格付不能' THEN 10
        WHEN column_9 = N'@Z農業，林業，漁業 間格付不能' THEN 11
        ...
        WHEN column_9 = N'DZ建設業 内格付不能' THEN 19
        ...
        WHEN column_9 = N'EZ製造業 内格付不能' THEN 45
        ...
        WHEN column_9 = N'G1通信業，放送業，映像・音声・文字情報制作業 内格付不能' THEN 57
        WHEN column_9 = N'G2情報サービス業，インターネット附随サービス業 内格付不能' THEN 58
        ...
        WHEN column_9 = N'HZ運輸業，郵便業 内格付不能' THEN 68
        WHEN column_9 = N'I卸売業，小売業' THEN 69
        WHEN column_9 = N'I1卸売業 内格付不能' THEN 70
        ...
        WHEN column_9 = N'I2小売業 内格付不能' THEN 77
        ...
        WHEN column_9 = N'JZ金融業，保険業 内格付不能' THEN 91
        WHEN column_9 = N'K不動産業，物品賃貸業' THEN 92
        WHEN column_9 = N'K1不動産業 内格付不能' THEN 93
        ...
        WHEN column_9 = N'LZ学術研究，専門・技術サービス業 内格付不能' THEN 103
        WHEN column_9 = N'M宿泊業，飲食サービス業' THEN 104
        WHEN column_9 = N'75宿泊業' THEN 105
        
        WHEN column_9 = N'M2飲食店，持ち帰り・配達飲食サービス業 内格付不能' THEN 107
        ...
        WHEN column_9 = N'NZ生活関連サービス業，娯楽業 内格付不能' THEN 114
        ...
        WHEN column_9 = N'PZ医療，福祉 内格付不能' THEN 124
        ...
        WHEN column_9 = N'R1サービス業（政治・経済・文化団体、宗教）内格付不能' THEN 131
        WHEN column_9 = N'93政治・経済・文化団体' THEN 132
        WHEN column_9 = N'94宗教' THEN 133
        WHEN column_9 = N'R2サービス業（政治・経済・文化団体、宗教を除く）内格付不能' THEN 134
