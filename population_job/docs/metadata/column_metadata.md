...
| 2 | year | INT | NO | 年度 | 年 | 〇 | - | レコードの該当年度 |
...
| 4 | year | INT | NO | 年度 | 年 | 〇 | - | レコードの該当年度 |
...
| 3 | year | INT | NO | 年度 | 年 | 〇 | - | レコードの該当年度 |
...
| number | column_name | type | nullable | japanese_column_name | unit | primary key | foreign key | notes |
|--------|-------------|------|----------|----------------------|------|-------------|-------------|-------|
| 1 | industry_code | INT | NO | 産業コード | - | 〇 | 〇 | 産業の分類を示すコード |
| 2 | industry_name | NVARCHAR(200) | NO | 産業名 | - | - | - | 産業名 |
...
| 1 | prefecture_code | INT | NO | 都道府県コード | - | 〇 | 〇 | 都道府県を示すコード |
| 2 | year | INT | NO | 年度 | 年 | 〇 | - | レコードの該当年度 |
| 3 | industry_code | INT | NO | 業種コード | - | 〇 | 〇 | 業種の分類を示すコード |
| 4 | employments_total_t | INT | YES | 全従業者数 | 人 | - | - | 全経営組織における全従業者数 |
| 5 | employments_total_m | INT | YES | 男性従業者数 | 人 | - | - | 全経営組織における男性従業者数 |
| 6 | employments_total_f | INT | YES | 女性従業者数 | 人 | - | - | 全経営組織における女性従業者数 |
| 7 | updated_at | DATETIME | NO | 更新日時 | - | - | - | 更新日時（自動更新） |
...
| number | column_name | type | nullable | japanese_column_name | unit | primary key | foreign key | notes |
|--------|-------------|------|----------|----------------------|------|-------------|-------------|-------|
| 1 | job_code | INT | NO | 産業コード | - | 〇 | 〇 | 産業の分類を示すコード |
| 2 | job_name_2012 | NVARCHAR(200) | NO | 2012年の産業名 | - | - | - | 2012年調査時の産業名。2012, 2016, 2021年のコードを一括でまとめるので、他年度で存在するが該当年度で存在しないコードに関しては「該当なし」とする。 |
| 3 | job_name_2016 | NVARCHAR(200) | NO | 2016年の産業名 | - | - | - | 2016年調査時の産業名。2012年、2016年、2021年のコードを一括でまとめるので、他年度で存在するが該当年度で存在しないコードに関しては「該当なし」とする。 |
| 4 | job_name_2021 | NVARCHAR(200) | NO | 2021年の産業名 | - | - | - | 2021年調査時の産業名。2012年、2016年、2021年のコードを一括でまとめるので、他年度で存在するが該当年度で存在しないコードに関しては「該当なし」とする。 |
